...
public class AndroidBillPaymentErrorTest extends BaseTest {
	...
	public void setUp(@Optional("@os='android'") String deviceQuery) throws Exception{
		...
		dc.setCapability("testName", "AndroidBillPaymentTestError");
...
//			e.printStackTrace();
//		}
        driver.findElement(By.xpath("//*[@id='accessCodeInput']")).sendKeys("0055826");
        try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
...
//			e.printStackTrace();
//		}
        driver.findElement(By.xpath("//*[@id='pinInput']")).sendKeys("123456");
...
//        driver.findElement(By.xpath("//*[@text='Ok, got it!']")).click();
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Billing organisation']")));
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='ALC']")));
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='form-ref-no']")));
        driver.findElement(By.xpath("//*[@id='form-ref-no']")).sendKeys("123456");
        new WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='currency']")));
