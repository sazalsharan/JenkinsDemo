...
public class AndroidTransferFundsTest extends BaseTest {
	...
	public void setUp(@Optional("@os='android'") String deviceQuery) throws Exception{
		...
		dc.setCapability("testName", "AndroidTransferFundsTest");
...
//        driver.findElement(By.xpath("//*[@text='Ok, got it!']")).click();
        ...
        driver.findElement(By.xpath("//*[@text='Singapore Account']")).click();
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Account number']")));
        driver.findElement(By.xpath("//*[@text='Account number']")).click();
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='POC Testing 3']")));
        //driver.executeScript("seetest:client.drag(\"//*[@text='POC Testing 3']\", 0, -100)");
        seeTest.drag("NATIVE", "//*[@text='POC Testing 3']", 0, 0, -100);
...
//        driver.executeScript("seetest:client.drag(\"//*[@text='Slide toSubmit']\", 1000, 0)");
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Confirm Transfer']")));
        driver.findElement(By.xpath("//*[@text='Confirm Transfer' and @scrollable='false']")).click();
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Submit']")));
        driver.getKeyboard().sendKeys("111111");
